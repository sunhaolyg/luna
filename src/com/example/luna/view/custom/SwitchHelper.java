...
public class SwitchHelper {
    ...
    private SwitchHelperCallback mSwitchHelperCallback;

    public SwitchHelper(SwitchHelperCallback callback) {
        this.mSwitchHelperCallback = callback;
        mPaint = new Paint();
    ...
    private void setSwitchState() {
        ...
        if (mSwitchHelperCallback != null) {
            mSwitchHelperCallback.onCheckedChange(mSwitchState == SWITCH_ON);
        }
    }
    ...
    private void postInvalidate() {
        if (mSwitchHelperCallback != null) {
            mSwitchHelperCallback.postInvalidate();
        }
    }

    private int getWidth() {
        if (mSwitchHelperCallback != null) {
            return mSwitchHelperCallback.getWidth();
        }
        return 0;
    }
    ...
    private int getHeight() {
        if (mSwitchHelperCallback != null) {
            return mSwitchHelperCallback.getHeight();
        }
        return 0;
    }

    public interface SwitchHelperCallback {
